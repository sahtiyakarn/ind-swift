                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <br>
                                <p class="blink text-center" style="color: #FF0030 !important;"><a><q>Herba Plus Division (A
                                            Franchisee Division)</q></a></p>
                                <p class="text-center" style="font-size: 20px;">The Sanskrit root Ayur means <span
                                        class="text-danger">“Longevity”</span> or <span class="text-danger">“Life”</span>
                                    and veda means <span class="text-danger">“Science”</span>. Ayurveda Provide as with the
                                    knowledge of how to prevent disease and how to eliminate its root cause if it does
                                    occur. The division of Ayurveda has been an integral part of <span
                                        class="text-danger"><q>IND-SWIFT LTD</q></span>.</p>
                                <br>
