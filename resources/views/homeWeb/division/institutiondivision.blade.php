                ...
                <div style="background-color:#000000;">
                    ...
                    <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                        ...
                        <svg viewbox="0 0 800 72" data-to="50% 50%" width="800" height="72" data-t="12"
                            ...
                            <text fill="#fafbfc" text-anchor="middle" x="400" y="72">Institution Division
                ...
                <div class="col-lg-8">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <br>
                                {{-- <p class="blink text-center" style="color: #FF0030 !important;"><a><q>Generic Division (A
                                            Franchisee Division)</q></a></p> --}}
                                <p class="text-justify" style="font-size: 20px;">Ind-Swift is a prominent organization and
                                    very well known amongst lakhs of employees of the railways, police force, armed forces
                                    and paramilitary organizations. The Institutional division of Ind-Swift caters to the
                                    government dispensaries (from the smallest to the biggest), ho,spitals even in the
                                    remote and rural areas of India.
                                    <br>
                                    The Institutional division of Ind-Swift caters to almost all the major government,
                                    semi-government and public sector undertakings in India. It is through this division
                                    that Ind-Swift makes its medicines available to even the remotest areas and army forward
                                    posts in Jammu and Kashmir and in the North- east. This division of Ind-Swift makes
                                    possible the government’s objectives of making the best quality medicines available to
                                    the common man at affordable prices. Ind-Swift’s adept team makes dedicated and untiring
                                    efforts in this direction to make these medicines available in almost every hospital in
                                    every corner of India.
                                </p>
                                <br>
                                <p class="text-center text-danger" style="font-size: 17px;"><q>To be an Outstanding division
                                        and set highest standards of patient care through Ayurvedic medicines for the
                                        benefits of humanity</q></p>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- <div class="container-fluid py-5" style="background-color: #283290;">
                        <div class="row">
                            ...
                            <div class="col-lg-2 img-hover py-2"><img src="{{ asset('assets/images/hp-1.jpg') }}"
                                    class="rounded mx-auto d-block" alt="..."></div>
                            <div class="col-lg-2 img-hover py-2"><img src="{{ asset('assets/images/hp-2.jpg') }}"
                                    class="rounded mx-auto d-block" alt="..."></div>
                            <div class="col-lg-2 img-hover py-2"><img src="{{ asset('assets/images/hp-3.jpg') }}"
                                    class="rounded mx-auto d-block" alt="..."></div>
                            <div class="col-lg-2 img-hover py-2"><img src="{{ asset('assets/images/hp-4.jpg') }}"
                                    class="rounded mx-auto d-block" alt="..."></div>
                            <div class="col-lg-2 img-hover py-2"><img src="{{ asset('assets/images/hp-5.jpg') }}"
                                    class="rounded mx-auto d-block" alt="..."></div>
