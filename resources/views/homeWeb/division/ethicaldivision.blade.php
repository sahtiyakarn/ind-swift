                ...
                <div style="background-color:#000000;">
                    ...
                    <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                        ...
                        <svg viewbox="0 0 800 72" data-to="50% 50%" width="800" height="72" data-t="12"
                            ...
                            <text fill="#fafbfc" text-anchor="middle" x="400" y="72">Ethical Division
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p class="text-center" style="font-size: 20px;">Ethical Division is having its own
                                    operations with fully skilled Marketing team. We have trained field force of more than
                                    300 people, operative in pan india.

                                    The Ethical division is dedicated to Gynaecology, Paediatrics, Dermatology and GP and
                                    its ambit extends to a wide range of medicines. The aim of this division is to provide
                                    patients and physicians with new and improved medicines that have better efficacy and
                                    fewer side effects.

                                    In this division the most popular and the best selling products are: Anin, Suprox, Cozy,
                                    Distone, Oliade.</p>
                                <br>
                            </div>
                        </div>
