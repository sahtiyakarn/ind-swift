                ...
                <div style="background-color:#000000;">
                    ...
                    <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                        ...
                        <svg viewbox="0 0 800 72" data-to="50% 50%" width="800" height="72" data-t="12"
                            ...
                            <text fill="#fafbfc" text-anchor="middle" x="400" y="72">Generic Division
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p class="text-center" style="font-size: 20px;">A generic drug is the brand equivalent, or
                                    bio-equivalent to their branded counterparts, they are typically sold at a lower price
                                    than the branded formulation. The Generic division is further divided into various
                                    therapeutic segments namely Antibiotic, Anti-Cold, Nutraceuticals, Anti-Diarrhoeal, Anti
                                    Malarial, Anti-Depressants.</p>
                                <br>
                                <p class="text-center text-danger" style="font-size: 17px;"><q>These drugs are available at
                                        reasonable prices.</q></p>
                            </div>
                        </div>
                    </div>
