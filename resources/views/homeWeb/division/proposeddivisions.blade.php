                ...
                <div style="background-color:#000000;">
                    ...
                    <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                        ...
                        <svg viewbox="0 0 800 72" data-to="50% 50%" width="800" height="72" data-t="12"
                            ...
                            <text fill="#fafbfc" text-anchor="middle" x="400" y="72">Proposed Division
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <br>
                                <p class="blink text-center" style="color: #FF0030 !important;"><a><q>Proposed Division (A
                                            Franchisee Division)</q></a></p>
                                <p class="text-center" style="font-size: 20px;">Today Ind-Swift is at a reigning pedestal
                                    and it enjoys a dominant position in various therapeutic segments. Ind-Swift believes
                                    that quality healthcare services have no boundaries and thus it plan to spread its wings
                                    by diversifying into the Herbal and Nutraceutical and OTC divisions. The objective is to
                                    create a good balance in all therapeutic areas.

                                <h4>Nutraceutical Division :</h4>

                                The carefree and indulgent lifestyle that most of us follow today, leads to many lifestyle
                                diseases like obesity, diabetes, cardiac and neurological disorders. Thus it is important to
                                maintain a proper lifestyle with healthy options. The Nutraceutical division, which is in
                                the pipeline, will manufacture products that offer healthy options and are in sync with
                                today’s lifestyle. These products will not compromise on taste and convenience but at the
                                same time will make your life more wholesome and functional. This division will produce
                                healthy, nutritious and reliable health foods.<p></p>
                                <h4>OTC Division :</h4>

                                It is Ind-Swift’s persistent endeavour to introduce new products and expand the already
                                existing product range and thereby increasing the market share of its products. Ind-Swift is
                                also venturing into the OTC market by opening its own division.</p>
                                <br>
                            </div>
                        </div>
                    </div>
