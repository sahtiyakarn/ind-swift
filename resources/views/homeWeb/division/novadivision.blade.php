                ...
                <div style="background-color:#000000;">
                    ...
                    <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                        ...
                        <svg viewbox="0 0 800 72" data-to="50% 50%" width="800" height="72" data-t="12"
                            ...
                            <text fill="#fafbfc" text-anchor="middle" x="400" y="72">Nova Division
                ...
                <div class="col-lg-8">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <br>
                                <p class="blink text-center" style="color: #FF0030 !important;"><a><q>Nova Division (A
                                            Franchisee Division)</q></a></p>
                                <p class="text-center" style="font-size: 20px;">The Nova Division being a multispecialty
                                    ...
                                    produced by the Nova Division is recognized for its effectiveness, long-shelf life and
                    ...
                    <div class="container-fluid py-5" style="background-color: #283290;">
                        <div class="row">
                            <div class="col-lg-1"></div>
                            <!-- <div class="img-hover"> -->
                            <div class="col-lg-2 img-hover"><img src="{{ asset('assets/images/nv-1.png') }}"
                                    class="rounded mx-auto d-block" alt="..."></div>
                            <div class="col-lg-2 img-hover"><img src="{{ asset('assets/images/nv-2.png') }}"
                                    class="rounded mx-auto d-block" alt="..."></div>
                            <div class="col-lg-2 img-hover"><img src="{{ asset('assets/images/nv-3.png') }}"
                                    class="rounded mx-auto d-block" alt="..."></div>
                            <div class="col-lg-2 img-hover"><img src="{{ asset('assets/images/nv-4.png') }}"
                                    class="rounded mx-auto d-block" alt="..."></div>
                            <div class="col-lg-2 img-hover"><img src="{{ asset('assets/images/nv-5.png') }}"
                                    class="rounded mx-auto d-block" alt="..."></div>
