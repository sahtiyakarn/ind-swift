            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h4 class="text-right">Select Preferred Year&nbsp;:-</h4>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center">
                                <select class="form-control" aria-label="Default select example">
                                    <option value="0">2015-16</option>
                        ...
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" aria-orientation="vertical">
                                ...
                                <a class="nav-link " href="/annexure_13st_list_of_depositors">Annexure 13st List of
                                    Depositors</a>
                                <a class="nav-link active" href="/list_of_fd_holder">List of FD Holder</a>
                                <a class="nav-link" href="/annexure_14th_to_16th_of_petitions">Annexure 14th to 16th of
                                    Petitions
                                </a>
                                    ...
                                    <div class="col-lg-2 mb-4">
                                        <div class="card">
                                            <div class="card-header text-center">
                                                <a href="{{ asset('investor_file/' . $item->upload_file) }}">
                                                    <img src="{{ asset('assets/images/pdf.png') }}" class="rounded-circle"
                                                        height="100px;" alt="">
                                                </a>
                                            </div>
