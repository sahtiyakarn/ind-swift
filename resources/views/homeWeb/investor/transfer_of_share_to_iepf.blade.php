                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" aria-orientation="vertical">
                                <a class="nav-link" href="/boardofdirector">Board of Director</a>
                                ...
                                <a class="nav-link " href="/general_meeting_transcripts">General Meeting
                                    Transcripts</a>
                                <a class="nav-link active" href="/transfer_of_share_to_iepf">Tranfer of Shares to IEPF</a>
                            </div>
                        </div>
                        <div class="col-9">
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1 mb-3">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4>Transfer of share to IEPF :</h4>
                                        </div>
                                        <div class="card-body">
