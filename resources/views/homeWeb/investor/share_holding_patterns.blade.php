                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" aria-orientation="vertical">
                                ...
                                <a class="nav-link " href="/annual_reports">Annual Reports</a>
                                ...
                                <a class="nav-link active" href="/share_holding_patterns">Share Holding Pattern</a>
                                ...
                                <div class="col-lg-10 offset-lg-1 mb-3">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4>Financial Year : {{ $year1->year }}</h4>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
